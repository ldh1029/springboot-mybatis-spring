...
public class NumberHelper {
    ...
    public static int toInt(String str) {
        return new Double(NumberUtils.toDouble(str, 0)).intValue();
    }
    ...
    public static int toInt(Object obj) {
        return toInt(StringHelper.toString(obj));
    }
    ...
    public static int toInt(String str, int defaultValue) {
        return new Double(NumberUtils.toDouble(str, defaultValue)).intValue();
    }
    ...
    public static double toDouble(Object obj) {
        return toDouble(StringHelper.toString(obj));
    }
