...
//    }
    ...
    public static Date beginOfWeek(final Date date) {
        return DateUtils.truncate(DateHelper.subDays(date, DateHelper.getDayOfWeek(date) - 1), Calendar.DATE);
    }
    ...
    public static Date nextWeek(final Date date) {
        return DateUtils.truncate(DateHelper.addDays(date, 8 - DateHelper.getDayOfWeek(date)), Calendar.DATE);
    }
